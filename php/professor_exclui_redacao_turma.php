...
<a href="../paginas/professor_redacoes_turma.php?codigo_tema=<?php echo $codigo_tema?>&codigo_turma=<?php echo $codigo_turma?>"><button class="botao" title="Voltar para página inicial">Voltar</button></a>
</center>
</div>
</body>
</html>