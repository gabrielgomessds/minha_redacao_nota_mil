...
header ("location: ../paginas/erro_cadastro_email_admin.php?nome=".$nome."&email=".$email."&senha=".$senha."&foto=".$caminho_imagem);
	}else{
$caminho_imagem = "../img/icone/icone_admin_sem_foto.png" ;
$sql = mysqli_query($conn,"INSERT INTO usuario (nome,email,senha,foto,tipo) VALUES ('".$nome."','".$email."','".$senha."','".$caminho_imagem."','".$tipo."')") ;
$sql = mysqli_query($conn,"INSERT INTO admin (nome,email,senha,foto) VALUES ('".$nome."','".$email."','".$senha."','".$caminho_imagem."')") ;
}
