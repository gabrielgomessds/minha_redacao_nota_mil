...
header ("location: ../paginas/erro_cadastro_email.php?nome=".$nome."&email=".$email."&escola=".$escola."&serie=".$serie."&codigo_acesso=".$codigo_acesso."&senha=".$senha."&foto=".$caminho_imagem);
}else{
