...
header("location: ../paginas/admin_erro_cadastro_aluno_email.php?nome=".$nome."&email=".$email."&codigo_acesso=".$codigo_acesso."&senha=".$senha."&foto=".$caminho_imagem);
...
header("location:../paginas/sucesso_admin_cadastra_aluno.php?codigo_turma=".$lista['id']);
