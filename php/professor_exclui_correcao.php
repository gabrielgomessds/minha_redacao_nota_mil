...
<a href="../paginas/professor_redacoes_aluno.php?codigo_tema=<?php echo $codigo_tema?>"><button class="botao" title="Voltar para página inicial">Tabela de redações</button></a>
<a href="../paginas/professor_ver_redacao.php?codigo_redacao=<?php echo $codigo_redacao?>"><button class="botao" title="Voltar para página inicial">Redação do aluno</button></a>
</center>
</div>
</body>
</html>