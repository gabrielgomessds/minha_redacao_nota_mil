				...
				<center>
					...
					?>
						<center>
							...
							<div class="mensagem" col="100" rows="30">
								...
								<p><i>(Resposta enviada pelo <?php echo $linha['remetente'] ?> no dia <?php echo date("d/m/Y \à\s H:i:s", strtotime($linha['data_envio'])); ?>)</i></p>
					...
					?>
						...
						<center>
							...
							?>
								<center>
									<h2 style="color:green;"><u>Faça seu comentario</u></h2>
								</center>
								<form method="POST" action="../php/envia_comentario.php">
									...
									<input type="text" name="data_comentario" value="<?php date_default_timezone_set('America/Fortaleza');
																						echo date('y-m-d H:i:s'); ?>" style="display:none;">
									<input type="text" name="tipo_usuario" value="aluno" style="display:none;">
								...
								?>
									<center>
										<h2 style="color:red;">Essa mensagem ainda não possui comentarios</h2>
									</center>
									<?php
								} else {
							...
							?>
								<center>
									<h1 style="color:red;">Está mensagem não permite comentarios</h1>
								</center>
							<?php
							}
							?>
