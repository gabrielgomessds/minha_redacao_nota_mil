...
<head>
    ...
    <title>Minha Redação - Erro e-mail</title>
...
<body style="background-color:#1abc9c;">
    ...
    <fieldset>
      <input placeholder="Esola" name="escola" type="text" style="display:none;" value="<?php echo $escola?>"  required>
    </fieldset>
    <fieldset>
      <input placeholder="Sexo" name="sexo" type="text" style="display:none;" value="<?php echo $sexo?>"  required>
       </fieldset>
	<fieldset>
