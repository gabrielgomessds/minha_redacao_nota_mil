...
<div class="app-title">
        <div>
		 ...
		 Voltar</button></a> <b style="font-size:20px;"> Textos Motivacionais. </b>    
	  ...
	  <center>
        <div class="col-md-8" align="center">
		  <?php
		  $nome_tema = $_GET['nome_tema'];
		$resultado = mysqli_query($conn,"SELECT * FROM temas_redacao where id='$nome_tema' ") ;
        ...
        <input type="text" name="codigo_tema" value="<?php echo $nome_tema?>" style="display:none;">
          <div class="tile">
			...
			<textarea class="texto-motivacional" name="texto1" rows="30" cols="100"></textarea>
			 </div>
			 <div style="display:none;" id="imagem1">
			 <label class="labelInput" >
    <input type="file" accept="image/*"  id="foto" name="imagem_texto1" onchange="loadFile1(event)"/>
    <span><img src="../img/icone/adicionar_imagem.png" title="Escolha uma imagem" name="foto" id="output1" style="width:140px;height:130px;cursor:pointer;" ></span>
	</label>
			</div>
			...
			<textarea class="texto-motivacional" name="texto2" rows="30" cols="100"></textarea>
			 </div>
			<div style="display:none;" id="imagem2">
			 <label class="labelInput" >
    <input type="file" accept="image/*"  id="foto" name="imagem_texto2" onchange="loadFile2(event)"/>
    <span><img src="../img/icone/adicionar_imagem.png" title="Escolha uma imagem" name="foto" id="output2" style="width:140px;height:130px;cursor:pointer;" ></span>
	</label>
			</div>
			...
			<textarea class="texto-motivacional" name="texto3" rows="30" cols="100"></textarea>
			
			 </div>
			 <div style="display:none;" id="imagem3">
			 <label class="labelInput" >
    <input type="file" accept="image/*"  id="foto" name="imagem_texto3" onchange="loadFile3(event)"/>
    <span><img src="../img/icone/adicionar_imagem.png" title="Escolha uma imagem" name="foto" id="output3" style="width:140px;height:130px;cursor:pointer;" ></span>
	</label>
		  ...
		  <input class="btn btn-success" type="submit" value="Finalizar Cadastro">
		  </form>
        </div>
		</center>
		</div>
