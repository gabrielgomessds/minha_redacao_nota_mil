...
$codigo_aluno = $_GET['id'];
$sql=mysqli_query($conn,"select * from aluno where id='$codigo_aluno'")or die(mysqli_error("Erro ao mudar o rascunho"));
while($row = mysqli_fetch_assoc($sql)){
$nomeUsuario = $row['nome'];
list($nome) = explode(' ',$nomeUsuario);		
?>
<h1><?php echo $nome?> seu rascunho foi alterado com sucesso!</h1>
