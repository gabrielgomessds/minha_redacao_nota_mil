...
<head>
    ...
    <title>Minha Redação - Erro Login</title>
	...
	<section id="login" class="login" >
	   ...
	   ?>    
				<div class="form-cadastro">
					...
					<center>
				<h3 style="color:red;">Email ou senha incorretos, por favor tente novamente</h3></center>
    <fieldset>
      <input placeholder="Endereço de email" name="email-login" type="email" value="<?php echo $email?>"  required>
    </fieldset>
    <fieldset>
