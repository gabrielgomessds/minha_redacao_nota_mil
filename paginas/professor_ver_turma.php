...
<div>
        <h1><a href="professor.php">
		  <button class="btn btn-success" type="button">Voltar</button></a> Turma <img src="../img/icone/menu/titulo/turma.png" width="40px" height="40px"></h1>     
    ...
    $prof = mysqli_fetch_assoc($pega_prof);
          ...
          <a onclick="muda('estatisticas')" ><button class="btn btn-info" style="background:orange;border-color:orange;" type="button">Estatísticas Gerais <img src="../img/icone/grafico.png"  class="icone_botao"></button></a></a>
  ...
  $codigo_turma = $_GET['codigo_turma'];
    ...
    <div class="col-md-10">
	    <div class="tile">
            ...
            <div class="tile-body">
              <form action="../php/alterar_turma.php" method="POST" enctype="multipart/form-data" style="text-align:left;">
        ...
        <input type="text" name="id" value="<?php echo $turma['id']?>" style="display:none;">
            ...
            <div class="tile-footer">
              ...
              <a href="../php/professor_retira_foto_turma.php?codigo_turma=<?php echo $turma['id']?>"><button class="btn btn-sucess" style="background:#551A8B;color:#FFF;">Retirar foto de perfil</button></a>
 ...
 <!---#########################################=MODAL EXCLUIR=##############################################################-->
      <div class="modal fade" id="excluir" role="dialog">
                ...
                <a href="../php/professor_exclui_turma.php?id=<?php echo $turma['id']?>" ><button class="button" width="110px" style="background:green;border-color:green;"  type="button">SIM</button></a>
...
<div>
	...
	<div class="tabcontent" id="temas" style="display:none">
        <div class="col-md-10" >
         ...
         and temas_redacao.codigo_professor = '".$turma['codigo_professor']."' or temas_redacao.codigo_turma = 'TurmasEspecificas' 
         and turmas_selecionadas.codigo_turma = '".$turma['id']."' and turmas_selecionadas.situacao = 'checked' 
         and temas_redacao.id = turmas_selecionadas.codigo_tema and turmas_selecionadas.codigo_professor = '".$turma['codigo_professor']."' 
         GROUP BY temas_redacao.id order by temas_redacao.id desc") ;
				...
				?>
					<a href="professor_redacoes_turma.php?codigo_tema=<?php echo $row['id']?>&codigo_turma=<?php echo $turma['id']?>"><button class="btn btn-success" type="button">Ver Redações<img src="../img/icone/menu/folha.png" width="16px" height="16px"></button></a>
					</td></a>
    ...
    <div class="col-md-10" id="alunos" style="display:none;">
          <div class="tile">
            ...
            <div class="table-responsive" >
              <table class="table">
              <a href="professor_cadastra_aluno.php?codigo_turma=<?php echo $turma['id'];?>"><button class="btn btn-default" style="background-color:#191970;color:#FFF;">Adicionar aluno <img src="../img/icone/icone_add_aluno.png" width="25px" height="25px"></button></a>
              
            <br><br>
         <?PHP
				$sql = mysqli_query($conn,"select * from aluno where codigo_turma='".$turma['id']."' order by nome asc");
        ...
        ?>
                ...
                <tbody >
                  <tr>
                    ...
                    <td><button data-toggle="modal" data-target="#exclui_<?php echo $usuario['id']?>" class="btn btn-danger">Excluir ALuno da turma</button></td>
                  ...
                  <strong>Senha: <?php echo $usuario['senha'];?></strong><br>
                   ...
                   <!--Janela Modal que exclui o aluno-->
								<div class="modal fade" id="exclui_<?php echo $usuario['id']?>" role="dialog">
								<div class="modal-dialog">
								<div class="modal-content">
								<div class="modal-header">
                  <h3>Tem certeza que deseja excluir este aluno da turma? </h3>
								...
								<div class="modal-body" align="center">
								<a href="../php/professor_exclui_aluno.php?codigo_aluno=<?php echo $usuario['id']?>&codigo_turma=<?php echo $turma['id']?>" ><button class="button" width="110px" style="background:green;border-color:green;"  type="button">SIM</button></a>
