...
<div>
    ...
    $busca_sem_corrigir = mysqli_query($conn,"SELECT * FROM redacao where codigo_tema='$codigo_tema' and codigo_turma = '$codigo_turma' and nota is null ") ;
            ...
            <div class="table-responsive">
              ...
              $turma = mysqli_fetch_assoc($busca_turma);
                  ...
                  <tr>
					...
					<?php }?></td>
                    <td><a href="admin_ver_redacao_turma.php?codigo_tema=<?php echo $row['id']?>&codigo_turma=<?php echo $codigo_turma?>"><button class="btn btn-success" type="button">Abrir <img src="../img/icone/menu/folha.png" width="16px" height="16px"></button></a></td>
					<td><a href="admin_ver_correcao_turma.php?id=<?php echo $row['id']?>&codigo_turma=<?php echo $codigo_turma?>"><button class="btn btn-info" type="button">Ver <img src="../img/icone/menu/olho.png" width="16px" height="16px"></button></a></td>
