...
include '../includes/correcao_caracteres.php';

$codigo_aluno = $_GET['codigo_aluno'];
$sql=mysqli_query($conn,"select * from professor where id='$codigo_aluno'");
...
<a href="professor.php"><button class="botao" title="Voltar para página inicial">Voltar</button></a>
</center>
<?php
}
?>
