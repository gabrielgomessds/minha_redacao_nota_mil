...
<h1>Mensagem Alterada com sucesso!!</h1>
<a href="admin_ver_mensagem.php?codigo_mensagem=<?php echo $codigo_mensagem?>"><button class="botao" title="Voltar para página inicial">Voltar</button></a>
</center>
</div>
