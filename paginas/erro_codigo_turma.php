...
<body style="background-color:#1abc9c;">
    ...
    <form id="form" action="../php/cadastro_erro_codigo_turma.php" method="post"enctype="multipart/form-data">
	<center>
    <img src="../img/icone/alerta.png" width="70px" height="70px">
    <p style="font-size:20px;"> <b style="font-style:italic;color:red;">Parece que o código digitado não existe ou está errado, por favor tente novamente</b></p>
	</center>
	<fieldset>
      <input placeholder="Nome completo" name="nome" type="text" value="<?php echo $nome?>" style="display:none;"  required >
    </fieldset>
    <fieldset>
      <input placeholder="Digite um novo codigo para acessar a turma" name="codigo_acesso" type="text"  required>
    </fieldset>
    <fieldset>
      <input placeholder="Digite um novo endereço de email" name="email" type="email" style="display:none;"  value="<?php echo $email?>"   required>
    </fieldset>
	<fieldset>
      <input placeholder="Senha maior de 6 digitos" name="senha" style="display:none;" type="text" value="<?php echo $senha?>"  required>
    </fieldset>
	<fieldset>
