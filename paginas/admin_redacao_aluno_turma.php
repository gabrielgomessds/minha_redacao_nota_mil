            ...
            <!--Janela Modal que exclui o aluno-->
                ...
                <a href=""><button class="button-modal" data-dismiss="modal" style="background:red;border-color:red;"  type="button">NÃO</button></a>
                  ...
                  <!--Janela Modal que mostra o aluno-->
								<div class="modal fade" id="<?php echo $row['codigo_aluno'];?>" role="dialog">
								<div class="modal-dialog">
								<div class="modal-content">
                  <br>
             ...
             <div class="modal-footer">
									<button type="button" class="btn btn-default" style="background-color:#00008B;color:#FFF;" data-dismiss="modal">Fechar</button>
								</div>
