...
<body style="background-color:gold;">
    ...
    <!-- Campo de login -->
	<section id="login" class="login" style="background-image: linear-gradient(to bottom, #9400D3, #8A2BE2);">
        <div class="container">
            ...
            <div class="row">
				...
				<div class="form-cadastro">
                    ...
                    <center><img src="../img/icone/tchau.gif" width="80px" height="80px"></center>
                     <center><h3 style="font-family:Arial Black;color:#9400D3;">Até a próxima</h3></center><br>
    <center><h3>Login<img src="../img/icone/icone_login.png" width="30px" height="30px"></h3></center>
    <fieldset>
    ...
    <fieldset>
	  ...
	  <p>
      <center><b style="color:red;text-decoreiton:none;" align="center">Página inicial click <a href="../index.html">aqui</a></b></center>
	  </p>
    </fieldset>
  </form>
            </div>
