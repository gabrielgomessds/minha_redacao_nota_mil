    ...
    <main class="app-content">
	  ...
	  <?php
		...
		$linha = mysqli_fetch_assoc($sql);
			...
			?>
           <h1><a href="professor_redacoes_aluno.php?codigo_tema=<?php echo $linha['codigo_tema']?>">
	 ...
	 ?>
		...
		<b style="color:blue;font-size:15px;"><?php echo $linha['nome_aluno']?></b> 
			...
			<h3>Tema: <?php echo $linha['tema']?> / NOTA: <?php 
					...
					?></h3>
			<br><br>
			<div class="btn" style="color:#FFF;background-color:red;display:inline-block;" data-toggle="modal" data-target="#exclui_correcao_<?php echo $linha['id'];?>" >Deletar Correção <img src="../img/icone/lixo.png" width="16px" height="16px"></div></center>
			<br>
			<?php 
			$codigo_correcao = $_GET['codigo_correcao'];
...
?>
		...
		<?php
			...
			?>
				...
				<div class="modal fade" id="exclui_correcao_<?php echo $linha['id'];?>" role="dialog">
                  ...
                  <h5>Tem certeza que deseja excluir essa correção?</h5><br>
								...
								<a href="../php/professor_exclui_correcao.php?codigo_redacao=<?php echo $linha['id'];?>&codigo_tema=<?php echo $linha['codigo_tema'];?>&codigo_turma=<?php echo $linha['codigo_turma']?>" ><button class="button-modal" width="110px" style="background:green;border-color:green;"  type="button">SIM</button></a>
			...
			<br>
	  <footer>
	<strong align="center">Gomess Productions | Todos os direitors reservados</strong>
	</footer>
    </main>
