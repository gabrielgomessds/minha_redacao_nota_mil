...
<body style="background-color:#1abc9c;">
    ...
    <form id="form" action="../php/cadastro_erro_email_prof.php" method="post"enctype="multipart/form-data">
	<center>
	...
	<fieldset>
      <input placeholder="Nome completo" name="nome_admin" type="text" value="<?php echo $nome?>" style="display:none;"  required >
    </fieldset>
    <fieldset>
      <input placeholder="Digite um novo endereço de email" name="email_admin" type="email"  required>
    </fieldset>
	<fieldset>
      <input placeholder="Senha maior de 6 digitos" name="senha_admin" style="display:none;" type="password" value="<?php echo $senha?>"  required>
    </fieldset>
	<fieldset >
	...
	<p>
	<center><b style="color:red;text-decoretion:none;"><a href="admin.php">Voltar</a></b></center>
	</p>
  </form>
