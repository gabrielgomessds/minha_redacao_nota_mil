...
<h1>O rank foi enviado com sucesso !!!</h1>
<a href="professor_rank.php?codigo_tema=<?php echo $codigo_tema?>"><button class="botao" title="Voltar para página inicial">Voltar</button></a>
</center>
</div>
</body>
</html>